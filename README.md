...
```
สามารถดูตัวอย่างการใช้ได้ที่ [![Open In Colab](https://colab.research.google.com/drive/1DLR-RAxkpLvQkXTqaa6uSbhPNNHGY3Zl?usp=sharing)
...
## Training
แม้ว่าลักษณะของชุดข้อมูลที่ตัวบทหนึ่งจะมีการกำกับทัศนคติ หรืออารมณ์ได้มากกว่า 1 ประเภท (Multi-label classification) แต่ผลการทำนายของโมเดล baseline ให้ผลค่อนข้างใกล้เคียงกับการตั้งโจทย์แบบ multi-class ดังนั้น ในการสร้างโมเดลวิเคราะห์อารมณ์และทัศนคติที่อยู่ในเอกสารทางการเงิน คณะวิจัยจึงเลือกแก้ปัญหาโจทย์แบบ Multi-class classification  หากข้อความใดมีมากกว่า 1 ป้ายกำกับ ป้ายกำกับแรกจะถูกเลือกมาใช้เท่านั้น โดยจะแยกเป็นโมเดลทำนายทัศนคติ 1 โมเดล และโมเดลทำนายขั้วอารมณ์ 1 โมเดล
